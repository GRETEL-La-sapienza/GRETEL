    ...
    local_config = {
         'parameters': {
             ...
             'model': {
                ...
                'parameters': {
                    'node_features':7,  # Assicurati di fornire un valore valido
...
if __name__ == "__main__":
    context = Context.get_context(config_file="config/TGITG-12725-1.4M/TGITG-12725-1.4M-GCN_GCounteRGAN0_0.jsonc")
